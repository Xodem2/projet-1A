...
public class Indices {
    ...
    public Indices(){
        ...
        indices.put("diffMat","Pour soustraire deux matrices, c'est un véritable jeu d'enfant, à condition qu'elles soient de mêmes dimensions : prenez une cellule située au même endroit dans chaque matrice, soustraire leur valeur, et vous obtenez alors le coefficient adéquat dans la nouvelle matrice ! Attention aux signes !");
