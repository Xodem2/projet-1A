...
public class Indices {
    ...
    public Indices(){
        ...
        indices.put("diffVect","La différence de vecteur se fait coordonnées par coordonnées : si x1 est la première coordonnées du vecteur 1 et x2 celle du vecteur 2 alors la première coordonnée de leur somme sera x1 + x2. Attention aux signes, un double moins se transforme en plus.");
        ...
        indices.put("diffMat","Pour soustraire deux matrices, c'est un véritable jeu d'enfant, à condition qu'elles soient de mêmes dimensions : prenez une cellule située au même endroit dans chaque matrice, soustraire leur valeur, et vous obtenez alors le coefficient adéquat dans la nouvelle matrice ! Attention aux signes, un double moins se transforme en plus.");
        ...
        indices.put("thalès","Il ne faut pas oublier les 3 égalités de Thalès ;) Encore une fois, on fait appelle à notre ami Yvan Monka https://youtu.be/JpU7X7AhB-A?t=75");
        indices.put("équation","Il suffit d'isoler x dans l'équation donnée pour trouver sa valeur");
        indices.put("équation2nd","Ici c'est un peu plus dur, il faut calculer le discriminant : b² - 4ac. En fonction du résultat, il y a deux, une, ou zéro solution. Plus d'info ici https://bit.ly/3HgnISY");
    }
